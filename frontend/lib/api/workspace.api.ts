...
export const workspaceApi = {
  ...
  getWorkspacePendingInvitations: async (workspaceId: string) => {
    const res = await apiService.get(`/workspaces/invitations/?workspace=${workspaceId}`);
    return res;
  },
  cancelWorkspaceInvitation: async (inviteId: string) => {
    const res = await apiService.delete(`/workspaces/invites/${inviteId}/cancel/`);
    return res;
  },
