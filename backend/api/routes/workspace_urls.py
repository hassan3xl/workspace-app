...
urlpatterns += [
    ...
    path(
        ...
        CancelWorkspaceInvitationView.as_view(),
        name="cancel-workspace-invite",
    ),

    path(
        "<uuid:workspace_id>/<uuid:user_id>/member-role/",
        WorkspaceMemberRoleView.as_view(),
        name="update-workspace-member-role",
    ),

    path(
        "<uuid:workspace_id>/logo/",
    ...
    path('<uuid:workspace_id>/members/<uuid:member_id>/remove/', 
